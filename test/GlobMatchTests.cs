...
class GlobMatchTests {
    ...
    public void MatchStar() {
        ...
        Assert.AreEqual(matchingFiles, new List<string>{"Folder/1File", "Folder/2File", "Folder/3File", "Folder/Thumbs"});
    }
    ...
    public void MatchStarPosfix() {
        ...
        Assert.AreEqual(matchingFiles, new List<string>{"Folder/1File", "Folder/2File", "Folder/3File"});
    }
    ...
    public void MatchStarOnePathOnly() {
        ...
        Assert.AreEqual(matchingFiles, new List<string>{"Uggabo", "Buggabo"});
    }
    ...
    public void MatchDoubleStar() {
        ...
        Assert.AreEqual(matchingFiles, new List<string>{"Parent/Child/Grandchild/a", "Parent/Child/Grandchild/b", "Parent/Child/Grandchild/c"});
    }
    ...
    public void MatchDoubleStarCapped() {
        ...
        Assert.AreEqual(matchingFiles, new List<string>{"Parent/Child/Grandchild/b"});
    }
}